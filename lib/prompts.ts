...
export function getQuizSystemPrompt(difficulty: string): string {
  return `You are an expert VTU professor generating a multiple choice quiz based strictly on the provided study notes. 
...
export const WEAK_TOPICS_SYSTEM_PROMPT = 
...
export const PYQ_SYSTEM_PROMPT = 
  "You are a helpful VTU assistant. Answer this VTU PYQ (Previous Year Question) using ONLY the provided context.";
